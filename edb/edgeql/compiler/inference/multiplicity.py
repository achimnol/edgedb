...
def __infer_type_introspection(
    ...
    *,
    ...
    # The result is always ONE, but we still want to actually
    # introspect the expression.
    return ONE
    ...
    *,
    ...
    for shape_set, _ in ir.shape:
        ...
        if shape_set.expr and shape_set.rptr:
            ...
            if (expr_mult is MANY and
                    not ptrref.out_target.is_scalar and
                    not ptrref.out_target.collection):
...
def _infer_set_inner(
    ...
    *,
    ...
    if rptr is not None:
        # Validate the source regardless
    ...
    if rptr is not None:
        ...
        if isinstance(rptr.ptrref, irast.TupleIndirectionPointerRef):
            ...
            return MANY
        elif ir.typeref.is_scalar or ir.typeref.collection:
...
def _infer_for_multiplicity(
    ...
    *,
    ...
    if not isinstance(ir.result, irast.Set):
        # We don't have a special handler for this case
        return MANY
